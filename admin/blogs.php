...
<div class="flex items-center justify-between mb-4">
  ...
  <div class="flex gap-2">
    <a href="blog_form.php" class="bg-gradient-to-r from-green-600 to-green-700 text-white px-4 py-2 rounded-lg hover:from-green-700 hover:to-green-800 transition font-medium"><i class="bi bi-plus-circle"></i> New Post</a>
